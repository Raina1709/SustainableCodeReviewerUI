    ...
    with image_col:
        ...
        if os.path.exists(local_gif_path):
            try:
                ...
                st.markdown(
                    f'<div style="display: flex; justify-content: flex-start; align-items: flex-start; height: 100%; padding-top: 20px; margin-left: -500px;">' # Changed justify-content and added margin-left
